...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(error);
      alert(
        "Oops! Something went wrong  - Please email me at marywebby1999@gmail.com"
      ); // show error message
    }
  };
        ...
        <div>
          ...
          >
            ...
            <input
              type="hidden"
              name="_autoresponse"
              defaultValue="Hello - Thank you for your email. In the meantime, be sure to check out my gitHub profile @ https://github.com/marywebby !"
            />
